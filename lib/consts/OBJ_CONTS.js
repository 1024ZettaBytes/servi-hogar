...
// Días de tolerancia por defecto antes de bloquear las acciones del técnico
// sobre un mantenimiento/reparación de venta pendiente. Un admin puede
// sobreescribir este valor de forma individual por registro (`allowedDays`
// en Mantainance/SaleRepair).
export const MANTAINANCE_DEFAULT_ALLOWED_DAYS = 3;

// Días extra que se agregan a `allowedDays` con el botón de un solo click
// (sin importar los días transcurridos desde la creación del mantenimiento).
export const MANTAINANCE_EXTRA_ALLOWED_DAYS = 3;
