export const ROUTES = {
  ...
  READY_MACHINES_OPERATOR_API: '/api/machines/ready-for-operator',
  LOAD_MACHINE_TO_VEHICLE_API: '/api/machines/load-to-vehicle',
  SKIP_MACHINE_API: '/api/machines/skip-machine',
  RETURN_MACHINE_TO_WAREHOUSE_API: '/api/machines/return-to-warehouse',
  STALE_MACHINES_ON_VEHICLE_API: '/api/machines/stale-on-vehicle',
  CONFIRM_RETURN_MACHINE_API: '/api/machines/confirm-return',
  DISMANTLE_MACHINE_API: '/api/machines/dismantle',
  // Warehouses
  ...
  SELL_RENT_MACHINE_API: '/api/rents/sell-machine',
  //
  ...
  ALL_MANTAINANCES_REASSIGN: '/api/mantainances//reassign-technician',
  ALL_MANTAINANCES_ADD_EXTRA_ALLOWED_DAYS: '/api/mantainances/add-extra-allowed-days',
  ...
  CONVERT_MACHINE_TO_SALE_API: '/api/sales-machines/convert-from-rent',
  ...
  COMPLETED_SALE_DELIVERIES_API: '/api/sales/deliveries/completed',
  PENDING_SALE_DELIVERIES_API: '/api/sales/deliveries/pending',
  UPDATE_SALE_CREDIT_API: '/api/sales/update-credit',
  ...
  // External Repairs
  ALL_EXTERNAL_REPAIRS_API: '/api/external-repairs',
  EXTERNAL_REPAIRS_RECOLECTADAS_API: '/api/external-repairs/recolectadas',
  EXTERNAL_REPAIR_BY_ID_API: '/api/external-repairs/:id',
  EXTERNAL_REPAIR_USED_PRODUCT_API: '/api/external-repairs/used-product',
  EXTERNAL_REPAIR_COMPLETE_PICKUP_API: '/api/external-repairs/complete-pickup',
  EXTERNAL_REPAIR_COMPLETE_DELIVERY_API: '/api/external-repairs/complete-delivery',
  EXTERNAL_REPAIR_COMPLETE_REPAIR_API: '/api/external-repairs/complete-repair',
  REGISTER_SALE_PAYMENT_API: '/api/sales/payment',
  ALL_SALE_PAYMENTS_API: '/api/sales/payments',
  CASH_CUTS_API: '/api/cash-cuts',
  ROUTE_CASH_SUMMARY_API: '/api/cash-cuts/route-summary',
  OFFICE_CASH_BOX_API: '/api/cash-cuts/office-box',
  ROUTE_CASH_CUT_API: '/api/cash-cuts/route',
  OFFICE_CASH_CUT_API: '/api/cash-cuts/office',
  CASH_CUT_DEPOSIT_API: '/api/cash-cuts/deposit',
  CASH_CUT_CONFIRM_API: '/api/cash-cuts/confirm',
  CASH_EXPENSES_API: '/api/cash-expenses',
  CANCEL_SALE_API: '/api/sales/cancel',
  CANCEL_ACTIVE_SALE_API: '/api/sales/cancel-active',
  // Sale Changes (Warranty Exchange)
  ALL_SALE_CHANGES_API: '/api/sales/changes',
  ALL_PENDING_SALE_CHANGES_API: '/api/sales/changes/pending',
  ALL_COMPLETED_SALE_CHANGES_API: '/api/sales/changes/completed',
  SALE_CHANGE_BY_ID_API: '/api/sales/changes/:id',
  ...
  REASSIGN_VUELTA_API: '/api/vueltas/reassign',
  ...
  PAYROLL_OPERATORS: '/api/payroll/operators',
  ...
  WAREHOUSE_CONDITIONING_FINISHED_API:
    '/api/warehouse-machines/conditioning-finished',
  REPLACE_RENTAL_MACHINE_API: '/api/warehouse-machines/replace-rental',
  APPLY_RENTAL_REPLACEMENT_API: '/api/warehouse-machines/apply-rental-replacement',
  CONDITIONED_WAREHOUSE_MACHINES_API: '/api/warehouse-machines?status=ACONDICIONADA&fields=minimal',
  INACTIVE_MACHINES_API: '/api/machines/inactive',
