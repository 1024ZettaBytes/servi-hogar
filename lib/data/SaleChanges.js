...
export async function markCompleteSaleChangeData({
  ...
  try {
    ...
    if (imagesUrl.front || imagesUrl.tag || imagesUrl.board) {
      ...
      if (delivery) {
        const updatedImagesUrl = { ...(delivery.imagesUrl || {}) };
        if (imagesUrl.front) updatedImagesUrl.frontal = imagesUrl.front;
        if (imagesUrl.tag) updatedImagesUrl.label = imagesUrl.tag;
        if (imagesUrl.board) updatedImagesUrl.board = imagesUrl.board;
        delivery.imagesUrl = updatedImagesUrl;
