...
export async function getCompletedSaleDeliveriesData(date, userId = null) {
  if (!isConnected()) {
    await connectToDatabase();
  }
  ...
  // Un operador solo ve sus propias entregas. Se filtra por assignedTo para
  // que el conteo coincida con el de la nomina (lib/data/Payroll.js).
  if (userId) {
