...
export async function getSalesData() {
  ...
  // Get all sales and then populate with delivery info if exists
  ...
  // For each sale, check if there's a completed delivery
...
export async function getPendingSalesData() {
  ...
  // Get pending/assigned deliveries with populated sale data
