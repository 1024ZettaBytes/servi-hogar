  ...
  const machinesWithPickup = await Promise.all(
    machines.map(async (machine) => {
      if (machine.wasReplaced) {
        // For replaced machines, the operator comes from the RentChange
      ...
      // Find latest finished pickup for this machine's last rent
      const pickup = await RentPickup.findOne({
