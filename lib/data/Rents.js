...
export async function changeRentPayDayData({ rentId, day, lastUpdatedBy }) {
  ...
  try {
    ...
    console.log({ rentId, day, lastUpdatedBy });
    ...
    console.log("Current end date: ",rent.endDate);
    ...
    console.log("Current: ",currentDay.toString());
    ...
    console.log("New rent date:", rent.endDate);
