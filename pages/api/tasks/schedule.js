...
export default async function handler(req, res) {
  ...
  try {
    ...
    const validTaskTypes = ['ENTREGA', 'RECOLECCION', 'CAMBIO', 'RECOLECCION_VENTA', 'CAMBIO_VENTA', 'COBRANZA', 'VUELTA_EXTRA', 'ENTREGA_VENTA', 'RECOLECCION_EXTERNA', 'ENTREGA_EXTERNA'];
